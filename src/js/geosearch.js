                ...
                selectResult: function(e) {
                    if ([h.ENTER_KEY, h.ARROW_DOWN_KEY, h.ARROW_UP_KEY].includes(e.keyCode)) {
                        ...
                        var t = this.searchElement.elements.input,
                            n = this.resultList;
                        if (e.keyCode === h.ENTER_KEY) {
                            var r = n.select(n.selected);
                        ...
                        var o = n.count() - 1;
                        if (o >= 0) {
                            var i = "ArrowDown" === e.code ? ~~n.selected + 1 : ~~n.selected - 1,
                                a = 0 > i ? o : i > o ? 0 : i,
                                u = n.select(a);
                            t.value = u.label
                        }
                ...
                return a(t, e), c(t, [{
                    ...
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            r = this.getParamString(s({}, n, {
                                format: "json",
                                q: t
                            }));
                        return "https://nominatim.openstreetmap.org/search?" + r
                    }
                }, {
                    key: "endpointReverse",
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            r = this.getParamString(s({}, n, {
                                format: "json",
                                osm_id: t.raw.osm_id,
                                osm_type: this.translateOsmType(t.raw.osm_type)
                            }));
                        return "https://nominatim.openstreetmap.org/reverse?" + r
                    }
                }, {
                    key: "parse",
                    value: function(e) {
                    ...
                    value: function(e) {
                        return new Promise(function(t, n) {
                            var r, o, i, a, u, s;
                            return r = e.query, o = e.data, i = ~location.protocol.indexOf("http") ? location.protocol : "https:", a = o ? this.endpointReverse({
                                data: o,
                                protocol: i
                            }) : this.endpoint({
                                query: r,
                                ...
                                return u = e, u.json().then(function(e) {
                                    return s = e, t(this.parse({
                                        data: o ? [s] : s
                                    }))
                                }.$asyncbind(this, n), n)
                            }.$asyncbind(this, n), n)
                    ...
                    value: function(e) {
                        return "node" === e ? "N" : "way" === e ? "W" : "relation" === e ? "R" : ""
                    }
                }]), t
            }(f.default);
        t.default = p
